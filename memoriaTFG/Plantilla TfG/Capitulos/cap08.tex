...
\label{tab:indices}
\includegraphics[width=0.95\textwidth]{diagramas/cuadros/cuadro-indices.png}
\end{table}
...
\label{tab:api-auth}
\includegraphics[width=0.95\textwidth]{diagramas/cuadros/cuadro-api-auth.png}
\end{table}
...
\label{tab:api-core}
\includegraphics[width=0.98\textwidth]{diagramas/cuadros/cuadro-api-core.png}
\end{table}
...
\includegraphics[width=0.85\textwidth]{diagramas/cuadros/cuadro-rendimiento.png}
\end{table}
...
\label{tab:colores}
\includegraphics[width=0.8\textwidth]{diagramas/cuadros/cuadro-colores.png}
\end{table}
...
posterior al cierre del plan inicial, y se validaron con 111 pruebas Jest (16 \emph{suites}) y
