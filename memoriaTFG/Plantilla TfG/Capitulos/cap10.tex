...
Los flujos de optimizador y OCR se implementan como tests a nivel de API (usando el \emph{fixture}
\texttt{request} de Playwright, sin interfaz de usuario) porque estas funcionalidades son exclusivas
de la app m\'ovil --- el portal web es exclusivamente de empresas y no dispone de pantallas de
